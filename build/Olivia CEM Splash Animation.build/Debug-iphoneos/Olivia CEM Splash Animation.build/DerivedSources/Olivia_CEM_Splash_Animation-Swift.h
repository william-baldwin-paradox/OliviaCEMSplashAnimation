...
#ifndef OLIVIA_CEM_SPLASH_ANIMATION_SWIFT_H
#define OLIVIA_CEM_SPLASH_ANIMATION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Olivia_CEM_Splash_Animation",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC27Olivia_CEM_Splash_Animation11AppDelegate") SWIFT_AVAILABILITY(ios,introduced=13.0)
...
@class UIWindow;
@class UIScene;
SWIFT_CLASS("_TtC27Olivia_CEM_Splash_Animation13SceneDelegate") SWIFT_AVAILABILITY(ios,introduced=13.0)
